...
class TestLogParser(unittest.TestCase):
    ...
    def test_parse_file(self):
        parser = LogParser(self.protcol_mapper, log_file,
                           self.lookup_table, self.tag_file, self.port_combination_file)
        tag_count = collections.Counter({'sv_p1': 1, 'sv_p2': 1})
        protocol_count = collections.Counter(
            {('25', 'tcp'): 1, ('443', 'tcp'): 1})
    ...
    def test_parse_file_empty_file(self):
        parser = LogParser(self.protcol_mapper, empty_log_file,
                           self.lookup_table, self.tag_file, self.port_combination_file)
    ...
    def test_generate_output(self):
        ...
        LogParser(self.protcol_mapper, log_file,
                  self.lookup_table, tag_file, port_file)
